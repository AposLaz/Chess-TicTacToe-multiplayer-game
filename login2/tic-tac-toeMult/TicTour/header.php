...
<nav style="border-bottom-right-radius: 25px;border-top-left-radius: 25px;border:2px solid black;" class="navbar navbar-default navbar-expand-lg navbar-light fixed-top sticky-top">
  ...
  <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
    ...
    <ul class="nav navbar-nav  navbar-right ml-auto "> 
      <li class="nav-item">
        <a href="#" data-toggle="dropdown" id="myUserName"  class="btn-login btn btn-primary dropdown-toggle get-started-btn mt-1 mb-1" style="background-color:red;color:white;border-radius:100px;"><?php echo $username; ?></a>
